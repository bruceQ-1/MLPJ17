...
# ================= 配置区域 =================
# 1. 在这里修改你想画的文件路径 (从你的截图中选一个)
# 例如: 
# file_path = "logs/eval_2025_standard_results.npz"   # Sundial
# file_path = "logs/xgboost_tuned_2025.npz"           # XGBoost
file_path = "/root/autodl-tmp/project/mlpj/results/logs/eval_2025_standard_results.npz"        # LSTM
