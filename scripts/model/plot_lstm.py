...
input: file end up with .npy
       /root/autodl-tmp/project/mlpj/results/logs/lstm_2025_standard_results.npz
...
# ================= 配置区域 =================
# npz文件地址
file_path = "/root/autodl-tmp/project/mlpj/results/logs/lstm_2025_standard_results.npz"        # LSTM
