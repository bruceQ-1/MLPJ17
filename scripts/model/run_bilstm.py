'''
name: run_bilstm.py
usage: use bidirectional LSTM to train and predict
...
output: /root/autodl-tmp/project/mlpj/results/logs/bilstm_2025_standard_results.npz
'''
...
output_npz = os.path.join(save_dir, "bilstm_2025_standard_results.npz")
output_img = "bilstm_2025_standard.png"
...
class BiLSTMModel(nn.Module):
    ...
    def forward(self, x):
        ...
        # 取最后一个时间步的输出 (包含正向的最后一步和反向的第一步特征)
...
# ================= 5. 训练模型 =================
print(f"2. Training Bi-LSTM ({epochs} Epochs)...")
model.train()
...
print("\n" + "="*40)
print(f"📊 Bi-LSTM 2025 Evaluation Report:")
